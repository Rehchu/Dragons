...
| # | Working title | State | Words | What it must carry |
|---|---|---|---|---|
| 12–16 | *(five chapters)* | ⬛ missing | 0 | The rising action: the temple's influence grows; wings spread across the Free Cities; the naming schism splits the league; the three withheld words start to be understood; Aldric — first to kneel — becomes prophet, prisoner, or both. Each chapter promotes one `(unexplained)` item from `LORE.md` into settled canon. |
...
- ✅ **`chapters/00-manuscript.md`** — **delivered.** The manuscript spine: acts, reading order,
  per-chapter beats, and the recurring-motif checklist, in one front-matter file.
